...
class item(MethodView):
    ...
    def put(self, item_data, item_id):
        ...
        if item:
            ...
            item = ItemModel(id=item_id, **item_data) # make sure to use the ID from the url and not generate one
...
class ItemList(MethodView):
    ...
    def post(self, item_data):
        ...
        try:
            ...
            abort(500, message="An error occured whilke inserting the item")
